...
const notate = (state = [{
  ...
  return [
      {...state[0],
        snare1: state[0].snare1 ^ tempoBin(keys,snare1KeyCombination,bits),
        snare2: state[0].snare2 ^ tempoBin(keys,snare2KeyCombination,bits),
        kick0: state[0].kick0 ^ tempoBin(keys,kick0KeyCombination,bits),
        kick1: state[0].kick1 ^ tempoBin(keys,kick1KeyCombination,bits),
      }, 
      ...state.slice(1)]
}
